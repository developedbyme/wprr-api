<?php
	...
	class PluginBase {
		...
		function __construct() {
			//echo("\Wprr\Core\PluginBase::__construct<br />");

			$this->register_hooks();
		}

		protected function register_lists() {
			//echo("\Wprr\Core\PluginBase::register_lists<br />");
		...
		protected function register_pages() {
			//echo("\Wprr\Core\PluginBase::register_pages<br />");
		...
		protected function add_additional_hook($additional_hook) {
			//echo("\Wprr\Core\PluginBase::add_additional_hook<br />");

			$this->_additional_hooks[] = $additional_hook;
		}

		protected function create_additional_hooks() {
			//echo("\Wprr\Core\PluginBase::create_additional_hooks<br />");

			//MENOTE: should be overridden
		}

		protected function register_additional_hooks() {
			//echo("\Wprr\Core\PluginBase::register_additional_hooks<br />");
		...
		protected function get_additional_hooks() {
			//echo("\Wprr\Core\PluginBase::get_additional_hooks<br />");
		...
		protected function add_filter($filter) {
			//echo("\Wprr\Core\PluginBase::add_filter<br />");

			$this->_filters[] = $filter;
		}

		protected function create_filters() {
			//echo("\Wprr\Core\PluginBase::create_filters<br />");

			//MENOTE: should be overridden
		}

		protected function register_filters() {
			//echo("\Wprr\Core\PluginBase::register_filters<br />");
		...
		protected function get_pages() {
			//echo("\Wprr\Core\PluginBase::get_pages<br />");
		...
		protected function get_custom_post_types() {
			//echo("\Wprr\Core\PluginBase::custom_post_types<br />");
		...
		protected function get_filters() {
			//echo("\Wprr\Core\PluginBase::get_filters<br />");
		...
		protected function create_rest_api_end_points() {
			//echo("\Wprr\Core\PluginBase::create_rest_api_end_points<br />");

			//MENOTE: should be overridden
		}

		protected function register_rest_api_end_points() {
			//echo("\Wprr\Core\PluginBase::register_rest_api_end_points<br />");
		...
		protected function get_rest_api_end_points() {
			//echo("\Wprr\Core\PluginBase::get_rest_api_end_points<br />");
		...
		public function register_hooks() {
			//echo("\Wprr\Core\PluginBase::register_hooks<br />");
		...
		public function hook_init() {
			//echo('\Wprr\Core\PluginBase::init<br />');
		...
		public function hook_admin_menu() {
			//echo("\Wprr\Core\PluginBase::hook_admin_menu<br />");
		...
		public function hook_admin_enqueue_scripts() {
			//echo("\Wprr\Core\PluginBase::hook_admin_enqueue_scripts<br />");
		...
		public function hook_rest_api_init() {
			//echo("\Wprr\Core\PluginBase::hook_rest_api_init<br />");
		...
		public function hook_edit_form_after_title() {
			//echo("\Wprr\Core\PluginBase::hook_edit_form_after_title<br />");
		...
		public function hook_edit_form_after_editor() {
			//echo("\Wprr\Core\PluginBase::hook_edit_form_after_editor<br />");
		...
		public function hook_save_post($post_id, $post, $update) {
			//echo("\Wprr\Core\PluginBase::hook_save_post<br />");
		...
		public static function test_import() {
			echo("Imported \Wprr\Core\PluginBase<br />");
		}
	}
?>

<?php
	...
	// \Wprr\Core\Admin\MetaData\MetaField
	class MetaField {
		...
		function __construct() {
			//echo("\Core\Admin\MetaData\MetaField::__construct<br />");
		...
		public function save($post_id) {
			//echo("\Core\Admin\MetaData\MetaField::save<br />");
		...
		public function output($post) {
			//echo("\Core\Admin\MetaData\MetaField::output<br />");
			
			//METODO
		}
		
		public static function test_import() {
			echo("Imported \Core\Admin\MetaData\MetaField<br />");
		}
	}
?>
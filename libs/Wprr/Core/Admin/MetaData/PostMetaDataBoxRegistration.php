<?php
	...
	// \Wprr\Core\Admin\MetaData\PostMetaDataBoxRegistration
	class PostMetaDataBoxRegistration {
		...
		function __construct() {
			//echo("\Core\Admin\MetaData\PostMetaDataBoxRegistration::__construct<br />");
		...
		public function save($post_id) {
			//echo("\Core\Admin\MetaData\PostMetaDataBoxRegistration::save<br />");
		...
		public function register() {
			//echo("\Core\Admin\MetaData\PostMetaDataBoxRegistration::register<br />");
		...
		public function register_save_hook() {
			//echo("\Core\Admin\MetaData\PostMetaDataBoxRegistration::register_save_hook<br />");
			
			add_action('save_post', array($this, 'save'));
		}
		
		public static function test_import() {
			echo("Imported \Core\Admin\MetaData\PostMetaDataBoxRegistration<br />");
		}
	}
?>
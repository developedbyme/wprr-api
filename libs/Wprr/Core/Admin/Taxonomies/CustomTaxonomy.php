<?php
	namespace Wprr\Core\Admin\Taxonomies;
	
	// \Wprr\Core\Admin\Taxonomies\CustomTaxonomy
	class CustomTaxonomy {
		...
		function __construct() {
			//echo("\Core\Admin\Taxonomies\CustomTaxonomy::__construct<br />");
		...
		public function set_names($system_name, $dipslay_name = null) {
			//echo("\Core\Admin\Taxonomies\CustomTaxonomy::set_names<br />");
		...
		public function register() {
			//echo("\Core\Admin\Taxonomies\CustomTaxonomy::register<br />");
		...
		public static function test_import() {
			echo("Imported \Core\Admin\Taxonomies\CustomTaxonomy<br />");
		}
	}
?>
<?php
	...
	use \Wprr\Core\Shortcode\ShortcodeFilter;
	
	// \Wprr\Core\Shortcode\PostTemplateShortcode
	class PostTemplateShortcode extends ShortcodeFilter {
		
		protected $_template_path = null;
		
		function __construct() {
			//echo("\Core\Shortcode\PostTemplateShortcode::__construct<br />");
		...
		public function apply_shortcode($attributes, $content, $tag) {
			//echo("\Core\Shortcode\PostTemplateShorctode::apply_shortcode<br />");
		...
		public static function test_import() {
			echo("Imported \Core\Shortcode\PostTemplateShortcode<br />");
		}
	}
?>
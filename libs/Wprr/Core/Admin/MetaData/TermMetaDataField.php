<?php
	...
	// \Wprr\Core\Admin\MetaData\TermMetaDataField
	class TermMetaDataField {
		...
		function __construct() {
			//echo("\Core\Admin\MetaData\TermMetaDataField::__construct<br />");
			
			
		}
		
		public function register_hooks() {
			//echo("\Core\Admin\MetaData\TermMetaDataField::register_hooks<br />");
		...
		public function save($term_id) {
			//echo("\Core\Admin\MetaData\TermMetaDataField::save<br />");
		...
		public function verify_and_save($term_id) {
			//echo("\Core\Admin\MetaData\TermMetaDataField::verify_and_save<br />");
		...
		protected function output_field($value) {
			//echo("\Core\Admin\MetaData\TermMetaDataField::output_field<br />");
			?>
		...
		public function output($term) {
			//echo("\Core\Admin\MetaData\TermMetaDataField::output<br />");
		...
		public function output_with_nonce($term) {
			//echo("\Core\Admin\MetaData\TermMetaDataField::output_with_nonce<br />");
		...
		public static function test_import() {
			echo("Imported \Core\Admin\MetaData\TermMetaDataField<br />");
		}
	}
?>
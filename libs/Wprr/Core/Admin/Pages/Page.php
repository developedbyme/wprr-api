<?php
	...
	class Page {
		...
		function __construct() {
			//echo("\Core\Admin\Pages\Page::__construct<br />");
		...
		public function set_names($name, $menu_name, $system_name) {
			//echo("\Core\Admin\Pages\Page::set_names<br />");
		...
		public function register_page() {
			//echo("\Core\Admin\Pages\Page::register_page<br />");
		...
		public function output() {
			//echo("\Core\Admin\Pages\Page::output<br />");
		...
		public static function test_import() {
			echo("Imported \Core\Admin\Pages\Page<br />");
		}
	}
?>
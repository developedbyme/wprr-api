<?php
	...
	class EndPoint {
		...
		function __construct() {
			//echo("\Core\RestApi\EndPoint::__construct<br />");
			
			$this->add_headers(array('Cache-Control' => 'no-cache'));
		}
		
		public function add_log($log_text) {
			//echo("\Core\RestApi\EndPoint::add_log<br />");
			$this->_logs[] = $log_text;
		}
		
		public function add_headers($headers) {
			//echo("\Core\RestApi\EndPoint::add_headers<br />");
		...
		public function setup($path, $namespace = 'oddapi', $version = 1, $method = 'GET') {
			//echo("\Core\RestApi\EndPoint::setup<br />");
		...
		public function perform_call($data) {
			//echo("\Core\RestApi\EndPoint::perform_call<br />");
		...
		public function hook_check_permission($request) {
			//echo("\Core\RestApi\EndPoint::hook_check_permission<br />");
			return current_user_can($this->_requiered_capability);
		}
		
		public function register_hooks() {
			//echo("\Core\RestApi\EndPoint::register_hooks<br />");
		...
		public static function test_import() {
			echo("Imported \Core\RestApi\EndPoint<br />");
		}
	}
?>
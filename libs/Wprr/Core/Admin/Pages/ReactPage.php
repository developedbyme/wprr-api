<?php
	...
	// \Wprr\Core\Admin\Pages\ReactPage
	class ReactPage extends Page {
		...
		function __construct() {
			//echo("\Core\Admin\Pages\ReactPage::__construct<br />");
		...
		public function output() {
			//echo("\Core\Admin\Pages\ReactPage::output<br />");
		...
		public static function test_import() {
			echo("Imported \Core\Admin\Pages\ReactPage<br />");
		}
	}
?>
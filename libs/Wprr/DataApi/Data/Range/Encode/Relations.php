<?php
	...
	class Relations {
		...
		public function encode($id) {
			...
			$current_direction = $post->get_user_relations();
			$types = $current_direction->get_types();
			$current_encoded_relations = array();
			...
			foreach($types as $type) {
				...
				$current_encoded_relations = array_merge($current_encoded_relations, $wprr_data_api->range()->encode_objects_as($relation_ids, 'userRelation'));
			}

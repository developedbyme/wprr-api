<?php
	...
	class UserRelation {
		...
		public function prepare($ids) {
			...
			$wprr_data_api->wordpress()->load_meta_for_user_relations($ids);
		}
		...
		public function encode($id) {
			...
			if(defined("READ_OBJECT_RELATION_TABLES") && READ_OBJECT_RELATION_TABLES) {
				...
				$encoded_data->data['type'] = $wprr_data_api->range()->encode_virtual_term('dbm_type', 'object-user-relation/'.$type, $type);
			}
			else {
